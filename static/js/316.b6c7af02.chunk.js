(self.webpackChunksyncswap = self.webpackChunksyncswap || []).push([[316], {
    51664: function(t) {
        "use strict";
        var e = {
            single_source_shortest_paths: function(t, r, n) {
                var o = {}
                  , i = {};
                i[r] = 0;
                var a, u, s, f, c, h, d, g = e.PriorityQueue.make();
                for (g.push(r, 0); !g.empty(); )
                    for (s in u = (a = g.pop()).value,
                    f = a.cost,
                    c = t[u] || {})
                        c.hasOwnProperty(s) && (h = f + c[s],
                        d = i[s],
                        ("undefined" === typeof i[s] || d > h) && (i[s] = h,
                        g.push(s, h),
                        o[s] = u));
                if ("undefined" !== typeof n && "undefined" === typeof i[n]) {
                    var l = ["Could not find a path from ", r, " to ", n, "."].join("");
                    throw new Error(l)
                }
                return o
            },
        ...
        t.exports = function(t) {
            for (var e = [], r = t.length, n = 0; n < r; n++) {
                ...
                if (o >= 55296 && o <= 56319 && r > n + 1) {
                    ...
                    i >= 56320 && i <= 57343 && (o = 1024 * (o - 55296) + i - 56320 + 65536,
                    n += 1)
                }
                o < 128 ? e.push(o) : o < 2048 ? (e.push(o >> 6 | 192),
                e.push(63 & o | 128)) : o < 55296 || o >= 57344 && o < 65536 ? (e.push(o >> 12 | 224),
                e.push(o >> 6 & 63 | 128),
                e.push(63 & o | 128)) : o >= 65536 && o <= 1114111 ? (e.push(o >> 18 | 240),
                e.push(o >> 12 & 63 | 128),
                e.push(o >> 6 & 63 | 128),
                e.push(63 & o | 128)) : e.push(239, 191, 189)
            }
            return new Uint8Array(e).buffer
        }
    },
    46316: function(t, e, r) {
        var n = r(48451)
          , o = r(48886)
          , i = r(49783)
          , a = r(29123);
    ...
    96877: function(t, e, r) {
        var n = r(8970).getSymbolSize;
        e.getRowColCoords = function(t) {
            if (1 === t)
                return [];
            for (var e = Math.floor(t / 7) + 2, r = n(t), o = 145 === r ? 26 : 2 * Math.ceil((r - 13) / (2 * e - 2)), i = [r - 7], a = 1; a < e - 1; a++)
                i[a] = i[a - 1] - o;
            return i.push(6),
            i.reverse()
        }
        ...
        e.getPositions = function(t) {
            for (var r = [], n = e.getRowColCoords(t), o = n.length, i = 0; i < o; i++)
                for (var a = 0; a < o; a++)
                    0 === i && 0 === a || 0 === i && a === o - 1 || i === o - 1 && 0 === a || r.push([n[i], n[a]]);
            return r
        }
    },
    85890: function(t, e, r) {
        var n = r(78952)
    ...
    73385: function(t, e) {
        ...
        e.getPenaltyN4 = function(t) {
            for (var e = 0, r = t.data.length, n = 0; n < r; n++)
                e += t.data[n];
    ...
    81435: function(t, e, r) {
        var n = r(59634);
        e.mul = function(t, e) {
            for (var r = new Uint8Array(t.length + e.length - 1), o = 0; o < t.length; o++)
        ...
        ,
        e.mod = function(t, e) {
            for (var r = new Uint8Array(t); r.length - e.length >= 0; ) {
                for (var o = r[0], i = 0; i < e.length; i++)
                    r[i] ^= n.mul(e[i], o);
                for (var a = 0; a < r.length && 0 === r[a]; )
                    a++;
                r = r.slice(a)
            }
            return r
        ...
        e.generateECPolynomial = function(t) {
            for (var r = new Uint8Array([1]), o = 0; o < t; o++)
                r = e.mul(r, new Uint8Array([1, n.exp(o)]));
            return r
        }
    },
    48886: function(t, e, r) {
        var n = r(8970)
          , o = r(18089)
          , i = r(18333)
          , a = r(22015)
          ...
          , p = r(33787);
        function v(t, e, r) {
            var n, o, i = t.size, a = g.getEncodedBits(e, r);
            for (n = 0; n < 15; n++)
                o = 1 === (a >> n & 1),
        ...
        function w(t, e, r) {
            ...
            r.forEach((function(e) {
                o.put(e.mode.bit, 4),
                o.put(e.getLength(), l.getCharCountIndicator(e.mode, t)),
                e.write(o)
            }
            ));
            var a = 8 * (n.getSymbolTotalCodewords(t) - c.getTotalCodewordsCount(t, e));
            for (o.getLengthInBits() + 4 <= a && o.put(0, 4); o.getLengthInBits() % 8 !== 0; )
                o.putBit(0);
            for (var u = (a - o.getLengthInBits()) / 8, s = 0; s < u; s++)
                o.put(s % 2 ? 17 : 236, 8);
            return function(t, e, r) {
                for (var o = n.getSymbolTotalCodewords(e), i = c.getTotalCodewordsCount(e, r), a = o - i, u = c.getBlocksCount(e, r), s = u - o % u, f = Math.floor(o / u), d = Math.floor(a / u), g = d + 1, l = f - d, p = new h(l), v = 0, w = new Array(u), m = new Array(u), y = 0, E = new Uint8Array(t.buffer), A = 0; A < u; A++) {
                    var C = A < s ? d : g;
                    w[A] = E.slice(v, v + C),
                    m[A] = p.encode(w[A]),
                    v += C,
                ...
                var B, I, M = new Uint8Array(o), T = 0;
                for (B = 0; B < y; B++)
                    for (I = 0; I < u; I++)
                        B < w[I].length && (M[T++] = w[I][B]);
                for (B = 0; B < l; B++)
                    for (I = 0; I < u; I++)
                        M[T++] = m[I][B];
                return M
        ...
        function m(t, e, r, o) {
            ...
            if (Array.isArray(t))
                ...
                if (!c) {
                    var h = p.rawSplit(t);
                    c = d.getBestVersionForData(h, r)
                }
                i = p.fromString(t, c || 40)
            }
            var g = d.getBestVersionForData(i, r);
            if (!g)
            ...
            var l = w(e, r, i)
              ...
              , y = new a(m);
            return function(t, e) {
                for (var r = t.size, n = s.getPositions(e), o = 0; o < n.length; o++)
                    for (var i = n[o][0], a = n[o][1], u = -1; u <= 7; u++)
                        if (!(i + u <= -1 || r <= i + u))
                            for (var f = -1; f <= 7; f++)
                                a + f <= -1 || r <= a + f || (u >= 0 && u <= 6 && (0 === f || 6 === f) || f >= 0 && f <= 6 && (0 === u || 6 === u) || u >= 2 && u <= 4 && f >= 2 && f <= 4 ? t.set(i + u, a + f, !0, !0) : t.set(i + u, a + f, !1, !0))
            }(y, e),
            function(t) {
            ...
            function(t, e) {
                for (var r = u.getPositions(e), n = 0; n < r.length; n++)
                    for (var o = r[n][0], i = r[n][1], a = -2; a <= 2; a++)
                        for (var s = -2; s <= 2; s++)
                            -2 === a || 2 === a || -2 === s || 2 === s || 0 === a && 0 === s ? t.set(o + a, i + s, !0, !0) : t.set(o + a, i + s, !1, !0)
            }(y, e),
            v(y, r, 0),
            e >= 7 && function(t, e) {
                for (var r, n, o, i = t.size, a = d.getEncodedBits(e), u = 0; u < 18; u++)
                    r = Math.floor(u / 3),
                    n = u % 3 + i - 8 - 3,
                    o = 1 === (a >> u & 1),
                    t.set(r, n, o, !0),
            ...
            isNaN(o) && (o = f.getBestMask(y, v.bind(null, y, r))),
            f.applyMask(o, y),
            v(y, r, o),
            {
                modules: y,
        ...
        e.create = function(t, e) {
            ...
            var r, i, a = o.M;
            return "undefined" !== typeof e && (a = o.from(e.errorCorrectionLevel, o.M),
            r = d.from(e.version),
            i = f.from(e.maskPattern),
            e.toSJISFunc && n.setToSJISFunction(e.toSJISFunc)),
            m(t, r, a, i)
        }
    },
    62149: function(t, e, r) {
        var n = r(81435);
        function o(t) {
            this.genPoly = void 0,
            this.degree = t,
    ...
    33787: function(t, e, r) {
        ...
        function g(t) {
            var e, r, o = d(s.NUMERIC, n.NUMERIC, t), i = d(s.ALPHANUMERIC, n.ALPHANUMERIC, t);
            return f.isKanjiModeEnabled() ? (e = d(s.BYTE, n.BYTE, t),
            r = d(s.KANJI, n.KANJI, t)) : (e = d(s.BYTE_KANJI, n.BYTE, t),
            r = []),
            o.concat(i, e, r).sort((function(t, e) {
        ...
        function p(t, e) {
            var r, s = n.getBestModeForData(t);
            if ((r = n.from(e, s)) !== n.BYTE && r.bit < s.bit)
                throw new Error('"' + t + '" cannot be encoded with mode ' + n.toString(r) + ".\n Suggested mode is: " + n.toString(s));
            switch (r !== n.KANJI || f.isKanjiModeEnabled() || (r = n.BYTE),
            r) {
            case n.NUMERIC:
                return new o(t);
            case n.ALPHANUMERIC:
        ...
        e.fromString = function(t, r) {
            for (var o = function(t) {
                ...
                return e
            }(g(t, f.isKanjiModeEnabled())), i = function(t, e) {
                for (var r = {}, o = {
                    start: {}
                    ...
                    for (var u = t[a], s = [], f = 0; f < u.length; f++) {
                        ...
                        for (var d = 0; d < i.length; d++) {
                            var g = i[d];
                            r[g] && r[g].node.mode === c.mode ? (o[g][h] = l(r[g].lastCount + c.length, c.mode) - l(r[g].lastCount, c.mode),
                            r[g].lastCount += c.length) : (r[g] && (r[g].lastCount = c.length),
                            o[g][h] = l(c.length, c.mode) + 4 + n.getCharCountIndicator(c.mode, e))
                        }
                    }
                    i = s
                }
            ...
            }(o, r), a = c.find_path(i.map, "start", "end"), u = [], s = 1; s < a.length - 1; s++)
    ...
    15741: function(t, e, r) {
        ...
        e.getCapacity = function(t, e, r) {
            ...
            var i = 8 * (n.getSymbolTotalCodewords(t) - o.getTotalCodewordsCount(t, e));
            if (r === a.MIXED)
                return i;
            var s = i - f(r, t);
            switch (r) {
        ...
        e.getBestVersionForData = function(t, r) {
            ...
            if (Array.isArray(t)) {
                if (t.length > 1)
                    return function(t, r) {
                        for (var n = 1; n <= 40; n++)
                            if (c(t, n) <= e.getCapacity(n, r, a.MIXED))
                                return n
                    }(t, o);
                if (0 === t.length)
                    return 1;
        ...
        e.getEncodedBits = function(t) {
            if (!u.isValid(t) || t < 7)
                throw new Error("Invalid QR Code version");
            for (var e = t << 12; n.getBCHDigit(e) - s >= 0; )
                e ^= 7973 << n.getBCHDigit(e) - s;
            return t << 12 | e
        }
    },
    49783: function(t, e, r) {
        var n = r(64425);
        e.render = function(t, e, r) {
            var o = r
              , i = e;
            "undefined" !== typeof o || e && e.getContext || (o = e,
            e = void 0),
            e || (i = function() {
                try {
        ...
        e.renderToDataURL = function(t, r, n) {
            var o = n;
            "undefined" !== typeof o || r && r.getContext || (o = r,
            r = void 0),
            o || (o = {});
    ...
    29123: function(t, e, r) {
        ...
        e.render = function(t, e, r) {
            var a = n.getOptions(e)
              ...
              , h = "<path " + o(a.color.dark, "stroke") + ' d="' + function(t, e, r) {
                for (var n = "", o = 0, a = !1, u = 0, s = 0; s < t.length; s++) {
                    var f = Math.floor(s % e)
                      , c = Math.floor(s / e);
                    f || a || (a = !0),
                    t[s] ? (u++,
                    s > 0 && f > 0 && t[s - 1] || (n += a ? i("M", f + r, .5 + c + r) : i("m", o, 0),
                    o = 0,
                    a = !1),
                    f + 1 < e && t[s + 1] || (n += i("h", u),
                    u = 0)) : o++
              ...
              , d = 'viewBox="0 0 ' + f + " " + f + '"'
              , g = '<svg xmlns="http://www.w3.org/2000/svg" ' + (a.width ? 'width="' + a.width + '" height="' + a.width + '" ' : "") + d + ' shape-rendering="crispEdges">' + c + h + "</svg>\n";
            return "function" === typeof r && r(null, g),
            g
        }
    },
    64425: function(t, e) {
        ...
        e.qrToImageData = function(t, r, n) {
            for (var o = r.modules.size, i = r.modules.data, a = e.getScale(o, n), u = Math.floor((o + 2 * n.margin) * a), s = n.margin * a, f = [n.color.light, n.color.dark], c = 0; c < u; c++)
                for (var h = 0; h < u; h++) {
                    var d = 4 * (c * u + h)
                      , g = n.color.light;
                    if (c >= s && h >= s && c < u - s && h < u - s)
                        g = f[i[Math.floor((c - s) / a) * o + Math.floor((h - s) / a)] ? 1 : 0];
                    t[d++] = g.r,
                    t[d++] = g.g,
                    t[d++] = g.b,
                    t[d] = g.a
